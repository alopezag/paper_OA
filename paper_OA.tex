...
%%
%% The "title" command
\title{OperatorAssist: A situational-aware multimodal digital assistant for assembly operators}
...
\begin{keywords}
  ...
  Digital Assistant (DA) \sep
  Digital Work Instructions (DWI) \sep
...
This research was funded by Flanders Make under the project OperatorAssist\_SBO, project number 2021-0133. Flanders Make is the Flemish strategic research center for the manufacturing industry in Belgium.
\end{acknowledgments}
